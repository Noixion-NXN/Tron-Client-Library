...
public class Hash {
  ...
  private static String HASH_256_ALGORITHM_NAME;
  private static String HASH_512_ALGORITHM_NAME;
   ...
   */
  public static byte[] sha3omit12(byte[] input, byte prefixByte) {
    byte[] hash = sha3(input);
    byte[] address = copyOfRange(hash, 11, hash.length);
    address[0] = prefixByte;
    return address;
  }
}
