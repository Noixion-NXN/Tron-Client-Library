...
/**
 * Contract for completing an exchange.
 */
public class ExchangeTransactionContract  extends TronContract {
    private final long exchangeId;
    private final long amount;
    private final String tokenName;

    public ExchangeTransactionContract(Contract.ExchangeTransactionContract contract) {
        super(Type.EXCHANGE_TRANSACTION, new TronAddress(contract.getOwnerAddress().toByteArray()));
